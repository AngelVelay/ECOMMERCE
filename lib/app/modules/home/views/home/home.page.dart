    ...
    return Container(
      ...
      child: SizedBox(
        ...
        child: ClipRRect(
          ...
          child: FadeInImage(
            fit: BoxFit.cover,
            placeholder: const NetworkImage('https://tenor.com/view/loading-gif-9212724.gif'),
            image: NetworkImage(carouselImage),
          )
        )
      ),
              ...
              child: Column(children: [
                ...
                SizedBox(
                  ...
                  child: const FadeInImage(
                      fit: BoxFit.cover,
                      placeholder: AssetImage('assets/images/esperanza_banner.png'),
                      image: AssetImage('assets/images/esperanza_banner.png')
                  )
                )
              ])            
            ),

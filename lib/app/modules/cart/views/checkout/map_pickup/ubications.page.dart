...
import '../../../../ubications/views/ubications/utills/map_utils.dart';

class MapPickupPage extends StatefulWidget {
  const MapPickupPage({Key? key}) : super(key: key);
...
class _CustomMarkerInfoWindowScreenState extends State<MapPickupPage> {
